...
```{r}
merged <- merged_data[merged_data$hpe == 24, c(1, 3, 4, 7, 8, 9, 11, 12, 13, 14, 15, 16, 17, 18, 19)] # get the rows for only the 24 hour mark since that's the day we saved everything in liquid nitrogen

merged <- merged[merged$treatment != 5, ] # get only the rows for the control and high nickel treatment
