...
ggplot(mort_exp, aes(x = Ni.Conc., y = percentage_mortality)) + 
  ...
  geom_smooth(aes(ymin = ci_lower, ymax = ci_upper), method = "lm", se = TRUE, color = "darkblue", fill = "blue", alpha = 0.2, size = 2) +  # Smooth line with CI shading
...
# Exploratory Survivorship Graph
```{r}
...
## Use of LC50 dataframe for LC50 Estimations
